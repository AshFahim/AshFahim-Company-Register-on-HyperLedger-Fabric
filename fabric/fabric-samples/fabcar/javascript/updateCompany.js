...
async function main(params) {
    try {
        ...
        // updateCompanyDetails transaction - requires 5 arguments
        await contract.submitTransaction('updateCompanyDetails', companyID, newName, newCompanyType, newEmployeeCount, newCountryOfOrigin);
